...
-- il est d�conseill� de mettre une valeur pour Id_Produit car l'attribut
--  AUTO_INCREMENT  permet de g�rer la cl� automatiquement
    -- 'L�gumes'
...
--  l'instruction suivante n est pas facile sans documentation sur internet ! ;)
...
-- Réfléxion sur le contenu des colonnes
