DROP TABLE IF EXISTS commentaire,note,historique,ligne_panier, ligne_commande, conditionnement, boisson, marque, type_eau, conteneur, volume, commande, adresse, etat, utilisateur;
