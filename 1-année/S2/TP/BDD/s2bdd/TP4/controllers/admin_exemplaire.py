...
def valid_add_exemplaire():
    ...
    if valid:
        ...
        exemplaire_insert(etat, date_achat, prix, id_oeuvre)
...
def delete_exemplaire():
    ...
    oeuvre_id = find_id_oeuvre_exemplaire(id_exemplaire)
...
def valid_edit_exemplaire():
    ...
    oeuvre = find_edit_details_oeuvre_id_exemplaire(oeuvre_id)
